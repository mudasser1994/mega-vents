...
import PhotoWidgetCropper from "./PhotosWidgetCropper";
            ...
            <Grid.Column width={4}>
                <Header color="teal" sub content="Step 3 - Preview & upload" />
                {
                    files.length > 0 && <>
                      ...
                      <Button.Group>
                        <Button loading={loading} style={{width:100}} onClick={handleImageUpload} positive icon="check" />
                        <Button disabled={loading} style={{width:100}} onClick={handleCancelCrop} icon="close" />
                      </Button.Group>
                    </>
                }
            </Grid.Column>
