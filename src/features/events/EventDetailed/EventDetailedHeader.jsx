...
<Segment.Group>
    ...
    <Segment attached="bottom" clearing>
        {
           !isHost && <>
             { isGoing ? <Button loading={loading} onClick={handleCancelJoinEvent}>Cancel My Place</Button> : <Button loading={loading} onClick={handleUserJoinEvent} color="teal">JOIN THIS EVENT</Button> }
           </>
        }
        {
