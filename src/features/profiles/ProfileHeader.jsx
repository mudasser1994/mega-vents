...
import { setFollowUser, setUnfollowUser } from "./store/profileActions";
import { CLEAR_FOLLOWINGS } from "./store/profileConstants";
                    ...
                    <Item.Group>
                        <Item>
                             ...
                             <Item.Content verticalAlign="middle">
                                 <Header as="h2" style={{display:"block" , marginBottom: 10}} 
                        ...
                        !isCurrentUser && (
                            ...
                            <Reveal animated="move">
                                ...
                                <Reveal.Content hidden style={{width:"100%"}}>
                                    <Button loading={loading} onClick={followingUser ? handleUnfollowUser : handleFollowUser  } basic fluid 
